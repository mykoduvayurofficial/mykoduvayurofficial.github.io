...
mykdrApp.run(['$rootScope', '$route', function($rootScope, $route) {
    ...
    $rootScope.engdata.mainData = {
        ...
        theme: {
            portrait: {
                pic1: "./images/theme/scenemob.jpg",
        ...
        festivals: {
            ...
            list: {
                ...
                thaipooyam: {
                    ...
                    location: {
                        title: "LOCATION",
                        info: "Keralapuram Gramam, Kurudamkulambu, Koymar Padam, Kakkayur, Nochur."
                    },
                    intro: {
                        title: "INTRODUCTION",
        ...
        festivals: {
            ...
            list: {
                ...
                thaipooyam: {
                    ...
                    location: {
                        title: "ഉത്സവാങ്കണം ",
                        info: "കേരളപുരം ഗ്രാമം, കുരുടംകുളമ്പ്. കൊയ്മര്‍ പാടം, കാക്കയൂര്‍, നൊച്ചൂര്‍."
                    },
                    intro: {
                        title: "മുഖവുര",
                    ...
                    season: {
                        title: "ഉത്സവവേള",
                        info1: "പഞ്ചാമൃതവും പാലഭിഷേകവും ആണ് സുബ്രഹ്മണ്യസ്വാമിക്ക് ഏറ്റവും വിശേഷപ്പെട്ട വഴിപാടുകള്‍. തൈപ്പൂയം ദിനത്തില്‍ കാലത്ത് ശ്രീ സുബ്രഹ്മണ്യ സന്നിധി ഉള്ള എല്ലാ ക്ഷേത്രങ്ങളിലും ശ്രീ സുബ്രഹ്മണ്യസ്വാമിക്ക് വിശേഷ അഭിഷേകങ്ങളും അലങ്കാരങ്ങളും വിശേഷ നിവേദ്യങ്ങളും പൂജകളും അലങ്കാര ദീപാരാധനയും ഉണ്ടാവും. ഇതിനു ശേഷം ഭക്തജനങ്ങള്‍ക്ക് പ്രസാദവിനിയോഗവും ഉണ്ടാവും. ഇതില്‍ ചില ക്ഷേത്രങ്ങളിലൊക്കെ വൈകീട്ടും വിശേഷപൂജകളും നിവേദ്യങ്ങളും സുബ്രഹ്മണ്യസ്വാമിക്ക് ചെയ്യാറുണ്ട്. അങ്ങനെ തൈപ്പൂയം ആഘോഷങ്ങള്‍ ഈ ക്ഷേത്രങ്ങളില്‍ പൂര്‍ണമാവും.",
                        info2: "കേരളപുരം ഗ്രാമം ശ്രീ മഹാഗണപതി ക്ഷേത്രത്തില്‍ തൈപ്പൂയം വളരെ ഭക്തിസാന്ദ്രതയോടെയും ആര്‍ഭാടത്തോടെയും എല്ലാവര്‍ഷവും ആഘോഷിക്കാറുണ്ട്. ഈ ക്ഷേത്രത്തിലെ എല്ലാ പ്രധാന പരിപാടികളും സംഘടിപ്പിക്കാറുള്ള ശ്രീ വിഘ്നേശ്വര സേവാ സമിതി ആണ് അനേകം ഭക്തജനങ്ങളുടെ സഹായ സഹകരണങ്ങളോടെ ഈ ഉത്സവവും ഇവിടെ നടത്തിവരുന്നത്. തൈപ്പൂയത്തിനു തലേദിവസം രാത്രി ക്ഷേത്രാങ്കണത്തില്‍ വെച്ച് കാവടിപൂജ ഉണ്ടാവും. നാദസ്വരത്തിന്റെയും ഭജനകളുടെയും ശബ്ദം ക്ഷേത്രപരിസരത്തില്‍ മുഴങ്ങവേ ഭക്തര്‍ കാവടി തോളില്‍ എടുത്ത് നൃത്തം ചെയ്യും. പൂജ കഴിയുന്നതോടെ കാവടികളുടെയും നാദസ്വരത്തിന്റെയും ഭജനയുടെയും അകമ്പടിയോടെ കാവടിയാടുന്ന ഭക്തരും മറ്റനേകം ഭക്തജനങ്ങളും ഗ്രാമത്തിനു ചുറ്റും പോകുന്ന ഒരു കാവടി എഴുന്നള്ളത്ത് ഉണ്ടാവും. കാവടികള്‍ പല വലിപ്പങ്ങളില്‍ ഉണ്ടാവാറുള്ളതുകൊണ്ട് പ്രായബേധമില്ലാതെ കുട്ടികള്‍ മുതല്‍ വലിയവര്‍ വരെ എല്ലാവരും കാവടിയെടുത്ത് ആവേശത്തോടെ നൃത്തം ചെയ്യാറുണ്ട്. ഇത് കാണാനും ഇതില്‍ പങ്കുചേരാനും അനേകം ജനങ്ങള്‍ എത്താറുണ്ട്. എഴുന്നള്ളത്ത് തിരിച്ച് ക്ഷേത്രത്തില്‍ എത്തുമ്പോള്‍ ദീപാരാധനയും പ്രസാദവിനിയോഗവും ഉണ്ടാവും. തൈപ്പൂയം ദിവസം കാലത്ത് ക്ഷേത്രത്തില്‍ പൂര്‍ണ്ണാഭിഷേകം നടക്കുമ്പോള്‍ വേദമന്ത്രങ്ങളുടെ ധ്വനികള്‍ ക്ഷേത്രത്തില്‍ മുഴങ്ങും. അഭിഷേകത്തിനു ശേഷം വിശേഷ നിവേദ്യവും അലങ്കാര ദീപാരാധനയും ഉണ്ടാവും. ഇതിനു ശേഷം ഒട്ടനവധി ഭക്തജനങ്ങള്‍ പങ്കെടുക്കുന്ന പ്രസാദ ഊട്ട് അഥവാ അന്നദാനം ഉണ്ടാവും. അവിടെ എത്തിച്ചേരുന്ന എല്ലാവര്‍ക്കും ലോഭമില്ലാതെ ശ്രീ മഹാഗണപതിയുടെ പ്രസാദം ലഭിക്കും. അന്നു വൈകീട്ട് ക്ഷേത്രത്തില്‍ വിശേഷ നിവേദ്യങ്ങളും ഭജനയും രാവോളം ഉണ്ടാവും. ഈ ക്ഷേത്രത്തിലെ തൈപ്പൂയ മഹോത്സവം കൊടുവായൂരില്‍ അറിയപ്പെടുന്ന ഉത്സവങ്ങളില്‍ ഒന്നാണ്. തൈപ്പൂയത്തോട് അനുബന്ധിച്ച് ഇവിടത്തെ പല ഭാഗങ്ങളില്‍ ഉള്ള കുട്ടികള്‍ നടത്തുന്ന രഥോത്സവങ്ങളാണ് ഈ ദിവസത്തെ ഏറ്റവും വലിയ സവിശേഷത. ഈ ബാലരഥോത്സവങ്ങളെക്കുറിച്ച് കൂടുതല്‍ അറിയുവാന്‍ തുടര്‍ന്ന്‍ വായിക്കുക."
                    },
                    celebration: {
                        title: "ബാലരഥോത്സവം",
                        info1: "700 വര്‍ഷത്തില്‍ ഏറെയായി കൊടുവായൂരില്‍ ആഘോഷിച്ചുവരുന്ന ഏറ്റവും വലിയ ഉത്സവമാണ് രഥോത്സവം. അതിനാല്‍ ഇവിടത്തെ കുട്ടികള്‍ മുതല്‍ മുതിര്‍ന്നവര്‍ വരെ ഓരോരുത്തരുടെ ഉള്ളിലും രഥങ്ങള്‍ക്കും രഥോത്സവത്തിനും ഒരു പ്രത്യേക സ്ഥാനം എപ്പോഴും ഉണ്ട്. രഥോത്സവം കഴിഞ്ഞുള്ള അടുത്ത വലിയ വിശേഷ ദിവസം ആയ തൈപ്പൂയം ദിനത്തില്‍ ഇവിടത്തെ നാനാഭാഗത്തുമുള്ള കുട്ടികള്‍ ഒത്തുചേര്‍ന്നുകൊണ്ട് അവരുടേതായ ആശയത്തോടെ രഥങ്ങള്‍ നിര്‍മ്മിച്ച് ശ്രീ സുബ്രഹ്മണ്യസ്വാമിയെ എഴുന്നള്ളിച്ചുകൊണ്ട് രഥോത്സവം കൊണ്ടാടാറുണ്ട്. അവരവരുടെ ആശയങ്ങള്‍ക്കും സൌകര്യങ്ങള്‍ക്കും ലഭിക്കുന്ന പിന്തുണക്കും സഹായങ്ങള്‍ക്കും അനുസരിച്ചാണ് രഥങ്ങള്‍ നിര്‍മ്മിക്കപ്പെടുകയും ഉത്സവം ആഘോഷിക്കപ്പെടുകയും ചെയ്യാറ്. ചെറിയ കുട്ടികള്‍ ഉണ്ടാക്കുന്ന ചെറിയ രഥങ്ങള്‍ മുതല്‍ കുറച്ചു മുതിര്‍ന്നവരുടെ അത്യന്തം അലങ്കൃതവും വലിപ്പമുള്ളതും മനോഹരവുമായ രഥങ്ങള്‍ വരെ അനേകം തരത്തിലുള്ള രഥങ്ങള്‍ ഈ ദിവസത്തില്‍ കൊടുവായൂര്‍ കേരളപുരം ഗ്രാമത്തിലെ വീഥികളിലൂടെ ഉരുളും. ലളിതമായ രഥോത്സവങ്ങള്‍ മുതല്‍ ആര്‍ഭാടപൂര്‍വ്വവും ഗംഭീരവുമായ രഥോത്സവങ്ങള്‍ വരെ പലതരത്തില് പല കൂട്ടായ്മകള്‍ നടത്തുന്ന‍ വ്യത്യസ്തമായ ആഘോഷങ്ങള്‍ ഉണ്ടാവാറുള്ള ഈ ദിവസത്തില്‍ തുല്യമായിട്ടുള്ളത് ഈ ആഘോഷങ്ങളില്‍ എല്ലാവരും പ്രകടമാക്കാറുള്ള ആവേശവും ആനന്ദവും ഭക്തിയും ആസ്വാദനവും ആണ്.",
                        info2: "രഥോത്സവം നടത്താന്‍ തീരുമാനിച്ചിട്ടുള്ള ഓരോ ഗണവും തൈപ്പൂയത്തിനു 10-15 ദിവസം മുന്‍പ് തന്നെ അതിനുള്ള തയ്യാറെടുപ്പുകള്‍ തുടങ്ങും. തേര് ഉണ്ടാക്കാന്‍ ആവശ്യമായ സാമഗ്രികളും ഉപകരണങ്ങളും സജ്ജികരിക്കല്‍, അതിനാവശ്യമായ ധനം സംഭരിക്കല്‍, രഥോത്സവത്തിനോട് അനുബന്ധിച്ചു വരുന്ന മറ്റു പരിപാടികളായ പൂജ, മേളം, പ്രസാദം, തേരിനുള്ള വെളിച്ചം, അലങ്കാരം, തുടങ്ങി ആ ദിവസത്തെ സമയക്രമം വരെ അവരവരുടെ ആശയങ്ങള്‍ക്കും സൌകര്യങ്ങള്‍ക്കും കിട്ടുന്ന പിന്തുണക്കും സഹായങ്ങള്‍ക്കും അനുസരിച്ച് ഓരോ ഗണവും തീരുമാനമെടുക്കും. ഇവിടത്തെ പല ജനങ്ങളും ഇതിന് നല്ലരീതിയില്‍ പിന്തുണയും സഹായങ്ങളും നല്കാറുണ്ട്. ഉത്സവത്തിന് തലേദിവസം ആവുമ്പോഴേക്കും എല്ലാ സജ്ജീകരണങ്ങളും പൂര്‍ത്തിയായിട്ടുണ്ടാവും. അന്നു രാത്രി ഓരോ ഗണവും അവരവരുടെ സ്ഥലത്ത് ഒത്തുചേര്‍ന്ന് സജ്ജീകരിച്ച എല്ലാ ഉപകരണങ്ങളും സാമഗ്രികളും കൂട്ടിച്ചേര്‍ത്ത് അവരുടെ തേര് പണിയും. പങ്കെടുക്കുന്ന ഓരോരുത്തര്‍ക്കും ഈ സമയം വളരെ രസകരവും ആസ്വാദ്യവും അതേസമയം സംഘടിതമായി പ്രവര്‍ത്തിക്കാനുള്ള ഒരു നല്ല അവസരം കൂടിയാവും. അങ്ങനെ തൈപ്പൂയം ദിവസം രാവിലെ ആവുമ്പോഴേക്കും കൊടുവായൂരിലെ നാനാഭാഗങ്ങളില്‍ ഓരോ ഗണത്തിലെയും രഥങ്ങള്‍ അലങ്കൃതമായി ഗ്രാമപ്രദക്ഷിണത്തിനു തയ്യാറായി നില്‍ക്കും. ചില ഗണങ്ങളില്‍ രഥങ്ങളുടെ പണി തീര്‍ക്കാന്‍ സംഘാടകര്‍ തിരക്കുകൂട്ടുന്ന കാഴ്ചകളും പതിവാണ്.",
                        info3: "തൈപ്പൂയം കൊടുവായൂരില്‍ വളരെ വിശേഷമായ ഒരു ദിവസമാണ്. അലങ്കൃതമായ ഓരോ രഥവും അതാത് തെരുവീഥികളില്‍ ‍എഴുന്നള്ളത്തിനു തയ്യാറാക്കി നാട്ടുകാര്‍ക്ക് കാണാന്‍ വേണ്ടി നിര്‍ത്തിയിട്ടുണ്ടാവും. ഇവിടെ എല്ലാക്കൊല്ലവും കണ്ടുവരുന്ന പ്രകാരം നോക്കുമ്പോള്‍ പൊതുവേ 3 കൂട്ടായ്മകള്‍ ആണ് വര്‍ഷം തോറും തൈപ്പൂയം രഥോത്സവം ആവേശത്തോടെയും ആര്‍ഭാടത്തോടെയും അതിഗംഭീരമായി സംഘടിപ്പിച്ച് ആഘോഷിക്കാറുള്ളത്. മൊക്കുത്തെരുവിലെയും ഇരട്ടത്തെരുവിലെയും യുവാക്കളെ ശ്രീ മഹാഗണപതി ക്ഷേത്രം കേന്ദ്രമാക്കി സംയോജിപ്പിക്കുന്ന ഒരു കൂട്ടായ്മയും, കേരളപുരം ഗ്രാമത്തിന്റെ തെക്കുഭാഗത്ത്‌ സ്ഥിതി ചെയ്യുന്ന കുരുടംകുളമ്പ് എന്ന സ്ഥലത്തിലെ യുവാക്കളെ സംയോജിപ്പിച്ചുള്ള ഒരു കൂട്ടായ്മയും കേരളപുരം ഗ്രാമത്തിലെ ഗോകുല തെരുവിലെ യുവാക്കളെ സംയോജിപ്പിച്ചുള്ള ഒരു കൂട്ടായ്മയും ആണ് അവ. നടത്തുന്ന ആളുകള്‍ ഒരു യുവതലമുറയില്‍ നിന്ന് മറ്റൊന്നിലേക്ക് മാറി മാറി വരുമ്പോഴും ഈ 3 കൂട്ടായ്മകളും തൈപ്പൂയം രഥോത്സവം പതിവുപോലെയും അതിലും നന്നായിട്ടും ഇക്കഴിഞ്ഞ കുറെ കൊല്ലങ്ങളായി നടത്തിവരാറുണ്ട്. ഈ 3 രഥങ്ങള്‍ കൂടാതെ മറ്റനേകം രഥങ്ങള്‍ ഈ ദിവസം കേരളപുരത്തിലെ തെരുവീഥികളില്‍ ഉരുളും.",
                        info4: "ഉത്സവ ദിവസം കേരളപുരം ഗ്രാമം ശ്രീ മഹാഗണപതി ക്ഷേത്രത്തിലെ പൂര്‍ണ്ണാഭിഷേകത്തിനു ശേഷം ശ്രീ സുബ്രഹ്മണ്യ സ്വാമിയുടെ ഒരു മൂര്‍ത്തി അവിടത്തെ രഥപൂജ കഴിച്ചതിനു ശേഷം രഥത്തിലേക്ക് ആരോഹിക്കും. കുരുടംകുളമ്പില്‍ അവിടത്തെ എല്ലാ ജനങ്ങളും ഈ ഉത്സവത്തില്‍ പങ്കെടുക്കും. അവിടെ ഈ ദിവസം ഉച്ചയോടെ ഉണ്ടാവുന്ന രഥപൂജയ്ക്കും രഥാരോഹണത്തിനും ശേഷം എല്ലാവര്‍ക്കും സുബ്രഹ്മണ്യ സ്വാമിയുടെ പ്രസാദ ഊട്ട് ഉണ്ടാവും. ഗോകുല തെരുവില്‍ രഥപൂജയും രഥാരോഹണവും വൈകുന്നേരം ആണ്. വൈകുന്നേരം 6 മണിയോടെ ഈ 3 രഥങ്ങളും അതാത് സ്ഥലങ്ങളില്‍ നിന്ന് വാദ്യഘോഷങ്ങളോടെ ഗ്രാമപ്രദക്ഷിണം തുടങ്ങും.",
                        info5: "ഇന്നേ ദിവസം രാവിലെ മുതല്‍ക്ക് തന്നെ അവരവരുടെ രഥങ്ങളില്‍ സുബ്രഹ്മണ്യസ്വാമിയെ എഴുന്നള്ളിച്ചുകൊണ്ട് അനവധി കൂട്ടായ്മകള്‍ കേരളപുരം ഗ്രാമത്തിലൂടെ കടന്നുപോവും. ഈ ദിവസത്തെ പ്രധാന ആഘോഷങ്ങളും ആകര്‍ഷണവും തുടങ്ങുന്നത് വൈകീട്ടാണ്. മേല്‍പ്പറഞ്ഞ 3 വലിയ കൂട്ടായ്മകള്‍ അവരുടെ രഥങ്ങള്‍ വാദ്യഘോഷത്തിന്റെയും വര്‍ണ്ണാഭമായ അലങ്കാരത്തിന്റെയും വെടിക്കെട്ടിന്റെയും വെളിച്ചത്തിന്റെയും അകമ്പടിയോടെ അവരുടെ എല്ലാ അംഗങ്ങളെയും പങ്കെടുപ്പിച്ചുകൊണ്ട് ഗ്രാമപ്രദക്ഷിണം തുടങ്ങും. ഇവരുടെ എഴുന്നള്ളത്തുകളില്‍ അനേകം നാട്ടുകാരും പങ്കെടുക്കും. ഓരോ കൂട്ടായ്മയും അവരുടെ രഥത്തെ ഗ്രാമത്തിലൂടെ എഴുന്നള്ളിക്കുമ്പോള്‍ തെരുവീഥികളില്‍ മുഴങ്ങുന്ന അവരുടെ വാദ്യമേളങ്ങളും യുവാക്കളുടെ ആര്‍പ്പുവിളികളും ഇത് കാണാന്‍ കൂടുന്ന ജനാവലിയും ഈ ഉത്സവാന്തരീക്ഷത്തിന് ആവേശം കൂട്ടും. ഓരോ ഗണവും അവരുടേതായ വഴിയും സമയക്രമവും നിശ്ചയിച്ചിട്ടുണ്ടാവും. ഈ ഉത്സവത്തിന്റെ പ്രധാന ആകര്‍ഷണം ആവുന്നത് ഇതിലെ 2 അല്ലെങ്കില്‍ 3 കൂട്ടായ്മകള്‍ അവരുടെ എഴുന്നള്ളത്തില്‍ തമ്മില്‍ കണ്ടുമുട്ടുമ്പോഴാണ്. എല്ലാ പ്രാവശ്യവും ഇങ്ങനെ ഉള്ള കണ്ടുമുട്ടലുകള് മൊത്തത്തില്‍‍ 3 - 4 പ്രാവശ്യം ഉണ്ടാവുന്ന പോലെയാണ് സമയക്രമവും വഴിയും ഉണ്ടാവുക. ഇങ്ങനെ 2 അല്ലെങ്കില്‍ 3 കൂട്ടായ്മകള്‍ അവരുടെ എഴുന്നള്ളത്തില്‍ കണ്ടുമുട്ടുമ്പോള്‍ ആവേശം ആര്‍ത്തിരമ്പും. ഈ ഉത്സവം ഇവിടെ ആഘോഷത്തിന്റെയും ഭക്തിയുടെയും പ്രതീകം മാത്രമല്ലാതെ കൂട്ടായ്മകള്‍ തമ്മിലുള്ള ഒരു മത്സരം കൂടിയായാണ് കാണുന്നത്. അതിനാല്‍ കൂട്ടായ്മകള്‍ ആഘോഷത്തില്‍ തമ്മില്‍ കണ്ടുമുട്ടുമ്പോള്‍ എല്ലാ വിധത്തിലും മറ്റുള്ളവരെക്കാള്‍ മികച്ചുനില്‍ക്കുവാന്‍ എല്ലാരീതിയിലും ശ്രമിക്കും. അലങ്കാരത്തിലും ആര്‍പ്പുവിളിയിലും ജനക്കൂട്ടത്തിലും വെടിക്കെട്ടിലും വാദ്യഘോഷങ്ങളിലും ഒക്കെ മത്സരിച്ചു നില്‍ക്കുന്ന കൂട്ടായ്മകള്‍ തമ്മില്‍ കണ്ടുമുട്ടുമ്പോള്‍ ആവേശം കൊടുമുടികേറും. ഇതിനുപുറമെ എഴുന്നള്ളത്തിന്റെ കൂടെ നാട്ടുകാര്‍ക്ക് പ്രസാദ വിതരണവും ഉണ്ടാവാറുണ്ട്.",
                        info6: "ഗ്രാമപ്രദക്ഷിണം പൂര്‍ത്തീകരിച്ച ശേഷം എല്ലാ രഥങ്ങളും അവരവരുടെ കേന്ദ്രങ്ങളിലേക്ക് മടങ്ങിയെത്തും. അതാതു ഭാഗങ്ങളില്‍ നിന്നും വെടിക്കെട്ടും ഉണ്ടാവും. ഇതിനുശേഷം പാനകനിവേദ്യവും പൂജാദീപാരധനയും പിന്നീട് പ്രസാദവിതരണവും ഉണ്ടാവും. ശ്രീ മഹാഗണപതി ക്ഷേത്രത്തില്‍ രഥം തിരിച്ചെത്തിയിട്ട്‌ രാവോളം ഭജനയും ഉണ്ടാവാറുണ്ട്. അങ്ങനെ എല്ലാ കൂട്ടായ്മകളും അവരുടെ തൈപ്പൂയ രഥോത്സവം നല്ലരീതിയില്‍ നടത്തി അവസാനിപ്പിച്ചതില്‍ ഒത്തുചേര്‍ന്നു ആഘോഷിക്കും. അടുത്ത ദിവസത്തിനുള്ളില്‍ ഓരോ കൂട്ടായ്മയും അവരുടെ രഥം അഴിച്ച് സാമഗ്രികളും ഉപകരണങ്ങളും അടുത്തകൊല്ലത്തിനായി സൂക്ഷിക്കും. അങ്ങനെ അവരുടെ ഒരു കൊല്ലത്തെ തൈപ്പൂയം ബാലരഥോത്സവത്തിനു കൂടി സമാപനമാവും."
                    },
                    specialities: {
                        title: "ഉത്സവവിശേഷം",
                        info: "തൈപ്പൂയം എന്ന ഉത്സവം ലോക ഹിന്ദുജനതയിലെ തമിഴ് വിഭാഗക്കാര്‍ അതിവിശേഷമായി ആഘോഷിക്കുന്ന ഒന്നാണ്. പ്രധാനമായും ഇന്ത്യ, ശ്രീലങ്ക, സിങ്കപ്പൂര്‍, മലേഷ്യ, ഇന്തോനേഷ്യ, തായ്‌ലാന്‍ഡ്‌, തുടങ്ങിയ രാജ്യങ്ങളില്‍ ഈ ഉത്സവം അത്യധികം ഭക്തിവിശേഷത്തോടെ ആഘോഷിക്കാറുണ്ട്. തിന്മക്കെതിരെയുള്ള നന്മയുടെ വിജയത്തെയാണ് ഈ ഉത്സവം സൂചിപ്പിക്കുന്നത്. സഹനവും ത്യാഗവും ഭക്തിയും ആണ് വിജയത്തിനുള്ള ചവിട്ടുപടികള്‍ എന്ന് ഈ ഉത്സവം നമ്മളെ പഠിപ്പിക്കുന്നു. ലോകമെമ്പാടുമുള്ള ഭക്തര്‍ ഉത്സവത്തിന് ആഴ്ചകള്‍ക്ക് മുന്‍പേ വ്രതശുദ്ധിയിലൂടെ തയ്യാറെടുത്ത് തുടങ്ങും. ചില വിനോദങ്ങളെയും ഭക്ഷണങ്ങളെയും ആസ്വാദനങ്ങളെയും ഒക്കെ ത്യജിച്ച് ഭക്തര്‍ മുരുഗഭക്തിയിലും പ്രാര്‍ത്ഥനയിലും മുഴുകുന്നു. ഉത്സവദിനത്തില്‍ ഒട്ടനേകം ഭക്തര്‍ കാവടി തോളിലേറ്റി ആടുമ്പോഴും വേല്‍ ദേഹത്ത് തുളച്ച് ധരിക്കുമ്പോഴും ശയനപ്രഥക്ഷിണം ചെയ്യുമ്പോഴും നഗ്നപാദങ്ങളോടെ ഈറന്‍ അണിഞ്ഞ് മലകയറുമ്പോഴും തല മുണ്ഡനം ചെയ്യുമ്പോഴും ഒക്കെ അവിടെ പ്രകടമാവുന്നത് അവരുടെ സഹനവും ത്യാഗവും കൂടാതെ ശ്രീ സുബ്രഹ്മണ്യ സ്വാമിയില്‍ അവര്‍ക്കുള്ള വിശ്വാസവും ഭക്തിയുമാണ്. ശ്രീ സുബ്രഹ്മണ്യ സ്വാമിക്ക് പ്രിയമായ അഭിഷേകത്തിനുള്ള പാലും മഞ്ഞനിറത്തിലും കാവിനിറത്തിലും ഉള്ള വസ്ത്രങ്ങളും പൂക്കളും ആഭരണങ്ങളും മറ്റും ഭക്തര്‍ സമര്‍പ്പിക്കുന്നു. ലോകത്ത് അനേകം സ്ഥലങ്ങളില്‍ ആയിരക്കണക്കിന് ജനങ്ങള്‍ പങ്കെടുക്കുന്ന ഘോഷയാത്രകള്‍ തൈപ്പൂയത്തിന്റെ ഭാഗമായി ഉണ്ടാവും. ഏതൊരു കാര്യത്തിലും വിജയം വരിക്കുവാന്‍ ശുദ്ധിയോടെയും സഹനത്തോടെയും ഭക്തിയോടെയും ത്യാഗത്തോടെയും പരമാത്മാവില്‍ വിശ്വസിച്ചു പ്രാര്‍ത്ഥിച്ചുകൊണ്ട് മുന്നോട്ട് പോവുക എന്നതാണ് ഈ ഉത്സവത്തിന്റെ സന്ദേശം. ലോകത്തിലെ മറ്റനേകം സ്ഥലങ്ങളിലെപ്പോലെ കൊടുവായൂരിലും തൈപ്പൂയം അതിവിശേഷമായി ആഘോഷിച്ചുവരുന്നു. "
                    },
                    gallery: {
                        title: "ഗാലറി",
                        info: "ഉത്സവത്തിന്റെ ചിത്രങ്ങളും വിഡിയോകളുടെയും ശേഖരം."
